                    ...
                    <li>
                        ...
                        <div class="unit">
                            ...
                            <ol class="storyActions">
                                <li>
                                    <a href="#" class="like" name="{{ $post->id }}">
                                        <i class="fa fa-heart"></i> {{ Auth::user()->likes()->where('post_id', $post->id)->first() ? Auth::user()->likes()->where('post_id', $post->id)->first()->like == 1 ? 'You like this post' : 'Like' : 'Like'  }}
                                    </a>
                                </li>
